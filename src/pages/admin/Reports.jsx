    ...
    <div>
      ...
      <div className="flex items-center justify-between mt-6 mb-8">
        <div className="flex flex-col gap-2">
          ...
          <p>
            Gain insights into platform performance and user activity trends
          </p>
        </div>
        ...
        <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
          ...
          <div className="flex gap-5 ">
            <div className="flex items-center justify-center rounded-xl overflow-hidden border border-border bg-card shadow-sm h-[380px] w-full">
              <Card className="w-full h-full border-none shadow-none">
                <CardHeader className="pb-2">
                  <CardTitle className="text-xl text-[#4C0082]">
            ...
            <div className="flex flex-col justify-between bg-card rounded-xl p-6 shadow-sm border border-border w-1/3 ">
              <h3 className="text-lg font-semibold text-[#4C0082] mb-4">
                Quick Insights
              </h3>
          ...
          <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
            ...
            <ul className="space-y-2 text-[15px]">
              <li className="flex justify-between border-b py-1">
                <span>Aslam Sheikh</span>{" "}
                <span className="font-medium text-primary">98%</span>
              </li>
              <li className="flex justify-between border-b py-1">
                <span>Sarah Amjad</span>{" "}
                <span className="font-medium text-primary">95%</span>
              </li>
              <li className="flex justify-between border-b py-1">
                <span>Ali Khan</span>{" "}
                <span className="font-medium text-primary">93%</span>
              </li>
              <li className="flex justify-between pt-2">
                <span>Nitasha kamran</span>{" "}
