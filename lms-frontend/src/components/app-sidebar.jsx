    ...
    <SidebarProvider>
      ...
      <div className="flex h-screen w-full">
        <Sidebar collapsible="icon" className="bg-background border-r group ">
          {/* Header */}
          <SidebarHeader>
            <div className="flex w-full items-start justify-start gap-3 py-2  font-semibold group ">
              {/* Logo - always visible */}
              <div className="w-9 h-9 flex items-center justify-center rounded-md bg-[#4c0082] shrink-0">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-56 p-3">
                    ...
                    <div className="flex flex-col gap-2 ">
                      <button className="flex items-center gap-2 px-2 py-1 rounded-md hover:bg-[#4c008210] hover:text-[#4b0082]">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-2 py-1 rounded-md hover:bg-[#ff000009] text-red-600"
                      >
